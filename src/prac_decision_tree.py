...
# Permutation importance import matplotlib.pyplot as plt
...
def plot_samples(X_train, Y_train, feature_names, classifier):
    ...
    #plt.show()
    plt.savefig("sample_plot_decision_tree.png", dpi=300)
    ...
    plt.suptitle('3D Partial Dependency Plot (Decision Tree)', fontsize=16)

    #plt.show()
    plt.savefig("PDP_plot_decision_tree.png", dpi=300)
