...
def main():
    ...
    df.to_csv('random_forest_shap_values_superstructure.csv')
    df_perf.to_csv('random_forest_performance_values_superstructure.csv')
    fprs_df.to_csv('random_forest_fprs_superstructure.csv')
    tprs_df.to_csv('random_forest_tprs_superstructure.csv')
